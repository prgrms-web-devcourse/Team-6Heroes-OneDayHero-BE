...
public class MissionChatRoomRedisRepository {
    ...
    private HashOperations<String, Long, MissionChatRoom> opsHashChatRoom;
     ...
     */
    public MissionChatRoom create(MissionChatRoom missionChatRoom) {
        opsHashChatRoom.put(CHAT_ROOMS, missionChatRoom.getId(), missionChatRoom);
    ...
    public Optional<MissionChatRoom> findById(Long missionChatRoomId) {
