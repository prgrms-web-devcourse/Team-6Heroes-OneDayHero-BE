...
class ReviewControllerTest extends RestDocsSupport {
    ...
    void createReviewWithImages() throws Exception {
        ...
        var reviewCreateRequest = createRequestToMultipartFile(objectMapper.writeValueAsString(request));
    ...
    private MockMultipartFile createRequestToMultipartFile(
            String json
    ) {
