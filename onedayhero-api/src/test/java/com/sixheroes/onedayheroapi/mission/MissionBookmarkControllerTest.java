...
class MissionBookmarkControllerTest extends RestDocsSupport {
    ...
    void createMissionBookmark() throws Exception {
        ...
        given(missionBookmarkService.createMissionBookmark(any(MissionBookmarkCreateApplicationRequest.class)))
                .willReturn(response);
    ...
    private MissionBookmarkCreateApplicationRequest createMissionBookmarkCreateApplicationRequest() {
